...
export default function PreferencesPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
      <div className="mb-6">
        <h1 className="font-serif text-2xl text-warm-700">Preferences</h1>
...
function DisplaySettings() {
  ...
  return (
    <div className="card p-6">
      <div className="mb-5">
        <h2 className="font-serif text-lg text-warm-700">Display</h2>
            ...
            <div className="flex items-center gap-2 px-4 py-2.5 bg-cream-50 border border-cream-200 rounded-lg">
              <span className="text-xs font-semibold text-warm-500 uppercase tracking-wide">
                ...
                <span className="text-warm-300 font-normal normal-case tracking-normal ml-1.5">
                  · {user.dayNameFormat === "FULL" ? "Sunday" : "Sun"}
                </span>
              </span>
            </div>
          </div>
