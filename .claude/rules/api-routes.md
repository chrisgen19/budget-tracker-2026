...
- `GET/PUT /api/cash-flow-forecast` — read a 30-, 60-, or 90-day tracked-balance forecast, or save its dated opening balance. The baseline date is refused when it is later than the user's current local calendar day.
